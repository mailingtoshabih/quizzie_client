...
export const Tablerow = ({ index, quiz }) => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText(quiz?.link);
        ...
        <div>
            ...
            >
                ...
                <div className={styles.svgcell} >
                    ...
                    <svg className={styles.svg} onClick={handleDelete} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className={styles.svg} onClick={handleCopy} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link to={`/question/${quiz?._id}`} className={styles.cell}>Questionwise Analysis</Link>
            </div>


            {
                deleteModal &&
                <Delete setDeleteModal={setDeleteModal} quiz={quiz} />
            }
