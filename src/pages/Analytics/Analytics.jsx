            ...
            <div className={styles.tableContainer}>
              ...
              {allquiz?.map((quiz, index) => (
                ...
                >
                  ...
                  <div className={styles.cell}>{"7 May 2056"}</div>
                  <div className={styles.cell}>{quiz.impression}</div>
